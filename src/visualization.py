...
def visual (df):
    ...
    # stats["prices"].plot(kind="barh", color="lightskyblue",  zorder=2)
    ...
    # plt.figure(figsize=(8, 6))
    # stats["top_drinks"]['count'].plot(kind="barh", color="lightskyblue", zorder=2)
    # plt.title("Number of Drinks bought (Annual)")
    ...
    # plt.figure(figsize=(8, 6))
    # stats["top_drinks"]['sum'].plot(kind='barh', color='lightskyblue', zorder=2)
    # plt.title("Sales of Drinks Bought")
    # plt.xlabel("Sales")
    # plt.ylabel("Coffee Type")
    # plt.gca().invert_yaxis()
    # plt.grid(axis ='x', zorder=1)
    ...
    # plt.figure(figsize=(8, 6))
    # data=stats["monthly_drinks"]['count']
    ...
    # month.reindex
    # month.plot(kind='line', marker='o', zorder=2)
    # plt.title("Annual Sales (by Drinks)")
    # plt.xlabel("Month")
    # plt.ylabel("Sales")
    # plt.xticks(rotation=0)
    # plt.grid(zorder=1)
    ...
    # plt.figure(figsize=(8, 6))
    # stats["hourly_drinks"]['count'].plot(kind="bar", color="lightskyblue", zorder=2)
    # plt.title("Number of Drinks bought per hour (Annual)")
    # plt.xlabel("Hour")
    # plt.ylabel("Drinks bought")
    # plt.xticks(rotation=0)
    # plt.gca().yaxis.set_major_locator(tck.MultipleLocator(25))
    # plt.grid(axis ='y', zorder=1)
    # plt.tight_layout()
    # plt.show()
    ...
    # plt.figure(figsize=(8, 6))
    # stats["drinks_TOD"]['count'].plot(kind="bar", color='lightskyblue', zorder=2)
    # plt.title("Number of Drinks bought per hour (Annual)")
    # plt.xlabel("Time of day")
    # plt.ylabel("Drinks bought")
    # plt.xticks(rotation=0)
    # plt.gca().yaxis.set_major_locator(tck.MultipleLocator(100))
    # plt.grid(axis ='y', zorder=1)
    # plt.tight_layout()
    # plt.show()
